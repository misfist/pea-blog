...
//                
    ...
    post: function(id) {
        console.log("post route is called.");
        console.log('Inside post function of routes - id: ', id);
...
//            
//            console.log('this.postsCollection is true');
//            
//            console.log( 'this.postsCollection.get(id) ', this.postsCollection.get(id) );
//            
//            this.post = this.postsCollection.get(id);
//            if(this.postView) {
//                this.postView.close();
...
//        } else {
//            
//            console.log('this.postsCollection is false');
//            
//            this.requestedID = id;
//            this.index();
//        }
